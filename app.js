...
var _fbedussi$elm15$Counter$digit = function (digit) {
	return A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class(
				A2(_elm_lang$core$Basics_ops['++'], 'counter-digit digit-', digit)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('counter-digitInner'),
					_1: {ctor: '[]'}
				},
				A2(
					_elm_lang$core$List$map,
					function (digit) {
						return A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(digit),
								_1: {ctor: '[]'}
							});
					},
					{
...
var _fbedussi$elm15$Counter$splitAndConvertNumber = function (number) {
	return A2(
		_elm_lang$core$String$split,
		'',
		A3(
...
var _fbedussi$elm15$Counter$counter = function (number) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(
			_elm_lang$core$List$map,
			_fbedussi$elm15$Counter$digit,
			_fbedussi$elm15$Counter$splitAndConvertNumber(number)));
};

var _fbedussi$elm15$Models$Model = F5(
	function (a, b, c, d, e) {
		return {tiles: a, turns: b, success: c, correctSequence: d, route: e};
	});
var _fbedussi$elm15$Models$resetModel = function (route) {
	return A5(
		_fbedussi$elm15$Models$Model,
		{
			ctor: '::',
			_0: 1,
			_1: {
...
var _fbedussi$elm15$Models$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _fbedussi$elm15$Models$Credits = {ctor: 'Credits'};
var _fbedussi$elm15$Models$Home = {ctor: 'Home'};

var _fbedussi$elm15$Msgs$ChangeLocation = function (a) {
	return {ctor: 'ChangeLocation', _0: a};
};
var _fbedussi$elm15$Msgs$OnLocationChange = function (a) {
	return {ctor: 'OnLocationChange', _0: a};
};
var _fbedussi$elm15$Msgs$Reset = {ctor: 'Reset'};
var _fbedussi$elm15$Msgs$NewSequence = function (a) {
	return {ctor: 'NewSequence', _0: a};
};
var _fbedussi$elm15$Msgs$Scramble = {ctor: 'Scramble'};
var _fbedussi$elm15$Msgs$Move = function (a) {
	return {ctor: 'Move', _0: a};
};

var _fbedussi$elm15$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _fbedussi$elm15$Models$Home, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
...
var _fbedussi$elm15$Routing$parseLocation = function (location) {
	var _p0 = A2(_evancz$url_parser$UrlParser$parsePath, _fbedussi$elm15$Routing$matchers, location);
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
		return _fbedussi$elm15$Models$NotFoundRoute;
	}
};

var _fbedussi$elm15$Init$init = function (location) {
	var currentRoute = _fbedussi$elm15$Routing$parseLocation(location);
	return {
		ctor: '_Tuple2',
		_0: _fbedussi$elm15$Models$resetModel(currentRoute),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};

var _fbedussi$elm15$Subscriptions$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};

var _fbedussi$elm15$Helpers$swapTiles = F2(
...
var _fbedussi$elm15$Helpers$isClickTileNextToZero = F2(
	function (clickedTile, tiles) {
		var tilesPerRow = 4;
		var zeroPos = A2(
			_elm_lang$core$Maybe$withDefault,
		...
		return ((_elm_lang$core$Native_Utils.eq(clickedTileRow, zeroRow) && _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$Basics$abs(clickedTileCol - zeroCol),
			1)) || (_elm_lang$core$Native_Utils.eq(clickedTileCol, zeroCol) && _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$Basics$abs(clickedTileRow - zeroRow),
			1))) ? true : false;
	});

var _fbedussi$elm15$Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ChangeLocation':
			...
			case 'OnLocationChange':
				var log = A2(_elm_lang$core$Debug$log, 'model', model);
				var newRoute = _fbedussi$elm15$Routing$parseLocation(_p0._0);
				return {
					ctor: '_Tuple2',
					_0: A5(_fbedussi$elm15$Models$Model, model.tiles, model.turns, model.success, model.correctSequence, newRoute),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Scramble':
				return {
					ctor: '_Tuple2',
					_0: _fbedussi$elm15$Models$resetModel(model.route),
					_1: A2(
						_elm_lang$core$Random$generate,
						_fbedussi$elm15$Msgs$NewSequence,
			...
			case 'Move':
				...
				return {
					ctor: '_Tuple2',
					_0: function () {
						if (A2(_fbedussi$elm15$Helpers$isClickTileNextToZero, _p2, model.tiles)) {
							var updatedCounter = model.turns + 1;
							var newTiles = A2(_fbedussi$elm15$Helpers$swapTiles, _p2, model.tiles);
							return A5(
								_fbedussi$elm15$Models$Model,
								newTiles,
								updatedCounter,
...
var _fbedussi$elm15$Icons$backIcon = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$svg$Svg$svg,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$height('43.882'),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$width('65.45'),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 65.449997 43.882458'),
					_1: {ctor: '[]'}
				}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$d('M19.35 42.841c2.2 2.2 6.1.7 6.1-2.5v-11.4h33c3.9 0 7-3.1 7-7s-3.1-7-7-7h-33v-11.4c0-3.2-3.8-4.7-6.1-2.5l-18.3 18.4c-1.4 1.4-1.4 3.6 0 5l18.3 18.4z'),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {ctor: '[]'}
...
var _fbedussi$elm15$Icons$okIcon = function (_p2) {
	var _p3 = _p2;
	return A2(
		_elm_lang$svg$Svg$svg,
		{
...
var _fbedussi$elm15$Icons$resetIcon = function (_p4) {
	var _p5 = _p4;
	return A2(
		_elm_lang$svg$Svg$svg,
		{
...
var _fbedussi$elm15$Icons$shuffleIcon = function (_p6) {
	var _p7 = _p6;
	return A2(
		_elm_lang$svg$Svg$svg,
		{
...
var _fbedussi$elm15$View$notFoundView = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
...
var _fbedussi$elm15$View$onLinkClick = function (message) {
...
var _fbedussi$elm15$View$homePage = function (model) {
	var creditsPath = 'credits';
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
							...
							return A2(
								_elm_lang$html$Html$button,
								{
									...
									_1: {
										...
										_0: _knledg$touch_events$TouchEvents$onTouchStart(
											function (_p0) {
												return _fbedussi$elm15$Msgs$Move(val);
											}),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_fbedussi$elm15$Msgs$Move(val)),
											_1: {ctor: '[]'}
										}
									}
								},
								{
									...
									_0: _elm_lang$html$Html$text(
										(!_elm_lang$core$Native_Utils.eq(val, 0)) ? _elm_lang$core$Basics$toString(val) : ''),
									_1: {ctor: '[]'}
								});
						},
						model.tiles)),
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _fbedussi$elm15$Counter$counter(model.turns),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
									...
									},
									{
										...
										_0: A2(
											_elm_lang$html$Html$button,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_fbedussi$elm15$Msgs$Scramble),
													_1: {ctor: '[]'}
												}
											},
											{
										...
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html$button,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_fbedussi$elm15$Msgs$Reset),
														_1: {ctor: '[]'}
													}
												},
												{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('linkBtn creditBtn'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href(creditsPath),
												_1: {
													ctor: '::',
													_0: _fbedussi$elm15$View$onLinkClick(
														_fbedussi$elm15$Msgs$ChangeLocation(creditsPath)),
													_1: {ctor: '[]'}
												}
											}
										},
...
var _fbedussi$elm15$View$creditsPage = function (_p1) {
	var _p2 = _p1;
	var homePath = '/';
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('creditsPage'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('creditsHeader'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('All icons are form the Noun Project'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('iconsCredit'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('iconsCredit-item'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('iconsCredit-icon'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('iconsCredit-text'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('by Setyo Ari Wibowo'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
								...
								},
								{
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('by Ananth'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _fbedussi$elm15$Icons$backIcon(
													{ctor: '_Tuple0'}),
												_1: {ctor: '[]'}
											}),
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('by praveen patchu'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('linkBtn backToHome'),
							_1: {
								ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: _fbedussi$elm15$View$onLinkClick(
										_fbedussi$elm15$Msgs$ChangeLocation(homePath)),
									_1: {ctor: '[]'}
								}
							}
						},
...
var _fbedussi$elm15$View$page = function (model) {
	var _p3 = model.route;
	switch (_p3.ctor) {
		case 'Home':
			return _fbedussi$elm15$View$homePage(model);
		case 'Credits':
			return _fbedussi$elm15$View$creditsPage(
				{ctor: '_Tuple0'});
		default:
			return _fbedussi$elm15$View$notFoundView;
	}
};
var _fbedussi$elm15$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _fbedussi$elm15$View$page(model),
			_1: {ctor: '[]'}
		});
};

var _fbedussi$elm15$Fifteen$main = A2(
	_elm_lang$navigation$Navigation$program,
	_fbedussi$elm15$Msgs$OnLocationChange,
	{init: _fbedussi$elm15$Init$init, view: _fbedussi$elm15$View$view, update: _fbedussi$elm15$Update$update, subscriptions: _fbedussi$elm15$Subscriptions$subscriptions})();

var Elm = {};
Elm['Fifteen'] = Elm['Fifteen'] || {};
if (typeof _fbedussi$elm15$Fifteen$main !== 'undefined') {
    _fbedussi$elm15$Fifteen$main(Elm['Fifteen'], 'Fifteen', {"types":{"unions":{"Msgs.Msg":{"args":[],"tags":{"OnLocationChange":["Navigation.Location"],"NewSequence":["Models.Tiles"],"Reset":[],"Scramble":[],"ChangeLocation":["String"],"Move":["Int"]}}},"aliases":{"Models.Tiles":{"args":[],"type":"List Int"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Msgs.Msg"},"versions":{"elm":"0.18.0"}});
}
